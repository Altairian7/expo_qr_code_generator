    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mainContent}>
        {currentPage === 'Home' && (
          <>
            ...
            <TouchableOpacity style={styles.button} onPress={() => alert('Navigate to Generate QR Code')}>
              <Text style={styles.buttonText}>Generate QR Code</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.button} onPress={() => alert('Navigate to Saved QR Codes')}>
              <Text style={styles.buttonText}>View Saved Codes</Text>
            </TouchableOpacity>
          </>
        )}
        {currentPage !== 'Home' && (
          <Text style={styles.pageContent}>{`${currentPage} Page Content`}</Text>
        )}
      </View>
      ...
      <View style={styles.bottomNavBar}>
        ...
        >
          ...
          />
          <Text style={[styles.navText, currentPage === 'Profile' && styles.activeNavText]}>Profile</Text>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <Text style={[styles.navText, currentPage === 'Settings' && styles.activeNavText]}>Settings</Text>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <Text style={[styles.navText, currentPage === 'About Us' && styles.activeNavText]}>About Us</Text>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <Text style={[styles.navText, currentPage === 'Terms' && styles.activeNavText]}>Terms</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
